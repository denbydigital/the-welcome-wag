// Welcome Wag — shared content + persona data (AU-localised). Exports WW_DATA to window.

const WW_PERSONAS = {
  cooper: {
    id: "cooper", name: "Cooper", breed: "Cocker Spaniel", age: "11 weeks", weight: "4.2 kg",
    background: "From a breeder", stage: "Day 1–7", dayLabel: "Day 3", arrival: "arrived 2 Jun 2026",
    suburb: "Newtown, NSW", postcode: "2042", firstTime: true, vet: "Newtown Veterinary Clinic",
    tone: "linear-gradient(140deg, var(--terracotta-300), var(--brand))", initial: "C",
  },
  luna: {
    id: "luna", name: "Luna", breed: "Kelpie ×", age: "2 years", weight: "17 kg",
    background: "Rescue (RSPCA)", stage: "First week", dayLabel: "Day 5", arrival: "arrived 31 May 2026",
    suburb: "Brunswick, VIC", postcode: "3056", firstTime: false, vet: "Brunswick Central Vet",
    tone: "linear-gradient(140deg, var(--sage-300), var(--sage-600))", initial: "L",
  },
  bear: {
    id: "bear", name: "Bear", breed: "Labrador", age: "8 weeks", weight: "5.6 kg",
    background: "From a breeder", stage: "Pre-arrival", dayLabel: "Arrives in 4 days", arrival: "arriving 8 Jun 2026",
    suburb: "Subiaco, WA", postcode: "6008", firstTime: true, vet: "—",
    tone: "linear-gradient(140deg, var(--honey-300), var(--honey-600))", initial: "B",
  },
};
...
const WW_SHOPPING = [
  { cat: "Feeding", icon: "utensils-crossed", items: [
    ...
    { name: "Puppy food — current brand", why: "Keep Cooper on the breeder's food for 1–2 weeks to avoid tummy upset.", brand: "Black Hawk Puppy", price: "$36", urgency: "now", have: true },
  ...
  { cat: "Sleeping", icon: "bed", items: [
    { name: "Crate or playpen", why: "A safe den helps a Cocker Spaniel settle and supports toilet training.", brand: "Pet One", price: "$89", urgency: "now", have: false },
  ...
  { cat: "Safety & ID", icon: "shield-check", items: [
    { name: "Council registration", why: "Required in NSW — register once vaccinated and microchipped.", brand: "Service NSW", price: "from $26", urgency: "now", have: false },
    { name: "Flat collar + ID tag", why: "Lifelong-registration aside, a visible tag gets a lost puppy home fast.", brand: "Anley", price: "$22", urgency: "now", have: false },
...
const WW_VET_QUESTIONS = [
  "Is Cooper's weight on track for an 11-week Cocker Spaniel?",
  ...
  "Any breed-specific things I should watch for with a Cocker?",
];
...
const WW_TIMELINE = {
  today: [
    ...
    { icon: "map-pin", tone: "sky", title: "Council registration", sub: "Required in NSW once microchipped", meta: "2 days" },
  ],
  upcoming: [
...
window.WW_DATA = { WW_PERSONAS, WW_FOODS, WW_BEHAVIOURS, WW_SHOPPING, WW_VETS, WW_VET_QUESTIONS, WW_ROUTINE, WW_TIMELINE };
